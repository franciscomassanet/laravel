...
@section('content')
	...
	<style>
		body {
			background-image: url("/img/wallpapers/studySkills.jpg");
    ...
    <main>
        ...
        <div class="container" style="background-color: rgba(255,255,255,0.5); ">
                ...
                <!-- Card -->
				<div class="card card-image" style="background-image: url(../img/icon/subject-studySkills.jpg); margin-top: 80px; margin-bottom:30px; padding:20px;">

					<!-- Content -->
					<div class="text-white text-center  align-items-center rgba-white-strong py-4 px-4">
						<div class="text-center">
							<h1 class="black-text text-center"><strong>Study Skills</strong></h1>
						</div>
					</div>
					<!-- Content -->
				</div>
				...
				<div class="row" style="padding: 10px;">
					<div class="col-md-4">
						...
						<div class="card mdb-color lighten-2 text-center z-depth-2">
							<div class="card-body">
								<h3 style="color:#ffffff;"><strong><i class="fa fa-flag fa-2x pull-left"></i> All Years</strong></h3>
							</div>
						</div>
						<!--/.Card Default-->
						 ...
						 <div class='col-lg-3 col-md-6 mb-r d-flex'>
							<div class='card card-cascade narrower d-flex'>
								...
								<div class='card-body text-center no-padding'>
										<div class='view'>
											<img src='/img/icon/subject-studySkills.jpg' class='img-fluid'>
