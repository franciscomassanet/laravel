...
@section('content')
	...
	<style>
		body {
			background-image: url("/img/wallpapers/enterprise.jpeg");
    ...
    <main>
        ...
        <div class="container" style="background-color: rgba(255,255,255,0.5); ">
                ...
                <!-- Card -->
				<div class="card card-image" style="background-image: url(../img/icon/subject-enterprise.jpg); margin-top: 80px; margin-bottom:30px; padding:20px;">

					<!-- Content -->
					<div class="text-white text-center  align-items-center rgba-white-strong py-4 px-4">
						<div class="text-center">
							<h1 class="black-text text-center"><strong>Enterprise</strong></h1>
						</div>
					</div>
					<!-- Content -->
				</div>
